...
HRESULT GameProcess::Initialize(HINSTANCE hInstance, int nCmdShow)
{
	...
	mOverlappedCallback = new OverlappedCallback{};
	mOverlappedCallback->InitSocket(mHwnd);
	mOverlappedCallback->BindAndListen(8000);
	mOverlappedCallback->StartServer();
