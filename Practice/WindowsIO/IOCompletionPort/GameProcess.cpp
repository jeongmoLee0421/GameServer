...
HRESULT GameProcess::Initialize(HINSTANCE hInstance, int nCmdShow)
{
	...
	mIOCompletionPort = new IOCompletionPort{};
	mIOCompletionPort->InitSocket();
	mIOCompletionPort->BindAndListen(8000);
	mIOCompletionPort->StartServer();
